...
namespace OutlookStyleControls
{
    ...
    public partial class OutlookGrid : DataGridView
    {
        ...
        private SkinDataGridView skin = SkinDataGridView.SkinOutlook;
        [Category("Skin")]
        public SkinDataGridView Skin
        {
            get { return skin; }
            set
            {
                skin = value;
                if (skin == SkinDataGridView.SkinOutlook)
                {
