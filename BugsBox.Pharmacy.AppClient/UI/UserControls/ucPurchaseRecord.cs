        ...
        private void BindDataSource()
        {
            try
            {
                ...
                if ((int)GridPurchaseRecordType < 4)
                {
                    ...
                    purchaseRecord.Add(new PurchaseRecord
                    {
                        Amount = purchaseRecord.Sum(r => r.Amount),
                        Money=decimal.Round(purchaseRecord.Sum(r=>r.Amount*r.Price),4),
                        ProductGeneralName="汇总"                        
                    });
