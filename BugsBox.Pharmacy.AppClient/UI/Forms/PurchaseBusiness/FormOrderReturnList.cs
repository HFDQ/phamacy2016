...
namespace BugsBox.Pharmacy.AppClient.UI.Forms.PurchaseBusiness
{
    public partial class FormOrderReturnList : BaseFunctionForm
    {
        ...
        public FormOrderReturnList()
        {
            ...
            cms.InsertMenuItem("查看采购订单", this.GetPurchaseOrder);
            cms.InsertMenuItem("查看采购收货单", this.GetPurchaseReceivingOrder);
            cms.InsertMenuItem("查看采购验收单", this.GetPurchaseCheckingOrder);
            cms.InsertMenuItem("查看采购入库单", this.GetPurchaseInInventoryOrder);
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dataGridView1.CurrentCell.OwningColumn.Name.Contains("Column3"))
            {
                ...
                if (perc == null)
                {
                    MessageBox.Show("请联系管理员，采购入库记录被删除！");
                    return;
                }
