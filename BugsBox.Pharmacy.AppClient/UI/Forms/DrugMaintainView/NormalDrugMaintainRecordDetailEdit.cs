...
{
   public partial class NormalDrugMaintainRecordDetailEdit : BaseFunctionForm 
    {
       public static bool IsEdit;//只读/编辑
       public NormalDrugMaintainRecordDetailEdit()
        {
            InitializeComponent();
        }
       ...
       {
           if (NormalDrugMaintainRecordDetailEdit.IsEdit)
           {
           ...
           string msg;
           DrugMaintainRecordDetail detail = PharmacyDatabaseService.GetDrugMaintainRecordDetail(out msg, NormalDrugMaintainRecordDetails.DrugMaintainRecordDetailId);
