...
{
    public partial class FormOrderReturnCancelIndex : BaseFunctionForm
    {
        private List<SalesOrderReturn> _salesOrderReturnList = new List<SalesOrderReturn>();
        ContextMenuStrip cms = new ContextMenuStrip();
        string msg = string.Empty;

        public FormOrderReturnCancelIndex()
        {
            InitializeComponent();
        ...
        private void GetListSalesOrderReturn()
        {
            try
            {
                ...
                var c = this.PharmacyDatabaseService.GetReturnOrderCancelCodePaged(scsi, out msg);
        ...
        {
            MyExcelUtls.DataGridview2Sheet(this.dataGridView1, "销售退货取消单");
        }
