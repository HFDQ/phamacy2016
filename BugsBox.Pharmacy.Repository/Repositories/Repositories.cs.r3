...
namespace BugsBox.Pharmacy.Repository
{
    ...
    /// 不合格药品存储实现
    /// </summary>
    public partial class DrugsUnqualificationRepository : CFRepository<drugsUnqualication>, IDrugsUnqualificationRepository
    {
        public RepositoryProvider RepositoryProvider { get; set; }
        public DrugsUnqualificationRepository(Db db)
            : base(db)
        {
        }
    }
