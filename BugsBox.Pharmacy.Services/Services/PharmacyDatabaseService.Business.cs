...
namespace BugsBox.Pharmacy.Services
{
    ...
    partial class PharmacyService
    {
        ...
        public IEnumerable<LackDrugModel> GetDrugInfoForOutofStock(out string message, int stockLower)
        {
            //Log.Warning("客户端开始调用GetDrugInfoForOutofStock");
            message = string.Empty;
            try
            {
                return HandlerFactory.DrugInfoBusinessHandler.GetDrugInfoForOutofStock(stockLower);
            }
            catch (Exception ex)
            {
                message = ex.Message;
        ...
        public System.Collections.Generic.IEnumerable<Business.Models.PurchaseOrderImpt> CheckForPurchaseOrderDetails(System.Collections.Generic.IEnumerable<Business.Models.PurchaseOrderImpt> List, out string message)
        {
            ...
            {
                message = "调用检查excel提交的采购单列表失败";
                return this.HandleException<System.Collections.Generic.IEnumerable<Business.Models.PurchaseOrderImpt>>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        public System.Collections.Generic.IEnumerable<Business.Models.Model_IdName> GetSuplyUnitIdNamesByQueryModel(Business.Models.BaseQueryModel q, out string message)
        {
            ...
            {
                message = "调用获取供货单位id和名称失败";
                return this.HandleException<System.Collections.Generic.IEnumerable<Business.Models.Model_IdName>>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        public System.Collections.Generic.IEnumerable<Business.Models.DrugInfoForPurchaseSelectorModel> GetDrugInfoForpurchaseSelector(DrugInfoForPurchaseSelectorQueryModel q, out string message)
        {
            ...
            {
                message = "调用用于采购时选择药品失败";
                return this.HandleException<System.Collections.Generic.IEnumerable<Business.Models.DrugInfoForPurchaseSelectorModel>>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        public Business.Models.LastPurchaseUnitPrice[] GetLastPurchaseUnitPrice(System.Guid[] DrugInfoIds, out string message)
        {
            ...
            {
                message = "调用获取品种最近一次采购价格失败";
                return this.HandleException<Business.Models.LastPurchaseUnitPrice[]>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        #region 根据OutInventory表中的OutInventoryStatus字段状态，读取出库表，用于拣货、复核等操作
        public System.Collections.Generic.IEnumerable<Business.Models.SalesOrderOutInventoryModel> GetWaitingOutInventoryList(Business.Models.SalesOrderOutInventoryQueryModel q, out string message)
        {
            ...
            {
                message = "调用根据OutInventory表中的OutInventoryStatus字段状态，读取出库表，用于拣货、复核等操作失败";
                return this.HandleException<System.Collections.Generic.IEnumerable<Business.Models.SalesOrderOutInventoryModel>>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        public DrugOutInventoryCheckModel[] GetDrugOutInventoryChecksByQueryModel(Business.Models.DrugOutInventoryCheckQueryModel q, out string message)
        {
            ...
            {
                message = "调用查询药品出库复核结果失败";
                return this.HandleException<DrugOutInventoryCheckModel[]>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        public Business.Models.SalesOrderForVATModel[] GetVATModelsbyQueryModel(Business.Models.SalesOrderForVATQueryModel q, out string message)
        {
            ...
            {
                message = "调用获取销售单For劳务清单失败";
                return this.HandleException<Business.Models.SalesOrderForVATModel[]>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        public Business.Models.SalesOrderDetailForVATModel[] GetSalesOrderDetailForVATModels(System.Guid SalesOrderId, out string message)
        {
            ...
            {
                message = "调用根据销售单ID获取VAT劳务清单的细节信息失败";
                return this.HandleException<Business.Models.SalesOrderDetailForVATModel[]>(message, ex);
            }
            finally
            {
                this.Dispose();
        ...
        public Business.Models.SalesOrderReturnDetailModel[] GetSalesOrderReturnDetailModels(Business.Models.SalesOrderReturnDetailQueryModel q, out string message)
        {
            ...
            {
                message = "调用销退细节查询失败";
                return this.HandleException<Business.Models.SalesOrderReturnDetailModel[]>(message, ex);
            }
            finally
            {
                this.Dispose();
