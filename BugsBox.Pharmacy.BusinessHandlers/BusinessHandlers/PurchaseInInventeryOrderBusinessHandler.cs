    ...
    partial class PurchaseInInventeryOrderBusinessHandler
    {
        ...
        public PurchaseOrderReturnDetailEntity[] getPurchaseInventoryDetatilEntity(Guid id)
        {
            ...
            var info = from f in invent.PurchaseInInventeryOrderDetails.OrderBy(r=>r.sequence)
                       join k in RepositoryProvider.Db.DrugInventoryRecords.Include(r=>r.DrugInfo) on f.Id equals k.PurchaseInInventeryOrderDetailId
                       ...
                       select new
                           PurchaseOrderReturnDetailEntity
                           {
                               ...
                               DictionaryMeasurementUnitCode = k.DrugInfo.DictionaryMeasurementUnitCode,
                               DictionarySpecificationCode = k.DrugInfo.DictionarySpecificationCode,
                               FactoryName = k.DrugInfo.FactoryName,
                               Id = Guid.NewGuid(),
                               IsReissue = false,
                               LicensePermissionNumber = k.DrugInfo.LicensePermissionNumber,
                               OutValidDate = f.OutValidDate,
                               ProductGeneralName = k.DrugInfo.ProductGeneralName,
                               ...
                               ReturnReason = "",
                               PurchaseInInventoryDetailId=f.Id
                           };
            var c = info.ToArray();
            return c;
        }
