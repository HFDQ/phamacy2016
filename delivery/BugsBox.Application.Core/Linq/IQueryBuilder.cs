...
namespace System
{
	...
	public static class IQueryBuilderExtensions
    {
        ...
        public static IQueryBuilder<T> GreaterThanOrEqual<T, P>(this IQueryBuilder<T> q, Expression<Func<T, P>> property,
                                                 P value)
        {
            Type type = typeof(P);
            var constantvalue = Expression.Constant(value);
            ...
            var c = Expression.GreaterThanOrEqual(nonNullProperty, constantvalue);
            q.AppendExpression(c);
            return q;
        }
        ...
        public static IQueryBuilder<T> LessThan<T, P>(this IQueryBuilder<T> q, Expression<Func<T, P>> property,
                                                         P value)
        {
            Type type = typeof(P);
            var constantvalue = Expression.Constant(value);
            ...
            var c = Expression.LessThan(nonNullProperty, constantvalue);
            q.AppendExpression(c);
            return q;
        }
        ...
        #region LessThanThanOrEqual

        public static IQueryBuilder<T> LessThanOrEqual<T, P>(this IQueryBuilder<T> q, Expression<Func<T, P>> property,
                                                 P value)
        {
            Type type = typeof(P);
            var constantvalue = Expression.Constant(value);
            ...
            var c = Expression.LessThanOrEqual(nonNullProperty, constantvalue);
            q.AppendExpression(c);
            return q;
        }
