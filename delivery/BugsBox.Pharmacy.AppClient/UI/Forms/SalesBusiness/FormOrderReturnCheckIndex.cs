...
{
    public partial class FormOrderReturnCheckIndex : BaseFunctionForm
    {
        private List<SalesOrderReturn> _salesOrderReturnList = new List<SalesOrderReturn>();
        ContextMenuStrip cms = new ContextMenuStrip();
        string msg = string.Empty;

        public FormOrderReturnCheckIndex()
        {
            InitializeComponent();
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            this.HideColumn();
            this.Column2.DisplayIndex = this.dataGridView1.ColumnCount - 1;
        ...
        {
            MyExcelUtls.DataGridview2Sheet(this.dataGridView1, "销售退货验收查询结果");
        }
