...
namespace BugsBox.Pharmacy.AppClient.UI.Forms.BaseForm
{
    public partial class FormOrderList : BaseFunctionForm
    {
        ...
        {            
            ...
            cms.Items[cms.Items.Count - 1].Enabled = false;
            cms.Items.Add("-");
            cms.Items.Add("查询历史配送入库单", null, delegate(object sender, EventArgs e) { this.RightMenuClick(3); });
            cms.Items.Add("-");
            cms.Items.Add("打开配送入库订单", null, delegate(object sender, EventArgs e) { this.RightMenuClick(4); });
            cms.Items.Add("-");
            cms.Items.Add("打开配送入库收货单", null, delegate(object sender, EventArgs e) { this.RightMenuClick(5); });
            cms.Items.Add("-");
            cms.Items.Add("打开配送入库单", null, delegate(object sender, EventArgs e) { this.RightMenuClick(6); });
