...
namespace BugsBox.Pharmacy.AppClient.UI.Forms.DataDictionary
{
    ...
    public partial class FormDictionaryDosage : BaseFunctionForm
    {
        private DictionaryDosage dosage = new DictionaryDosage();
        ...
        private void RefreshDataView()
        {
            ...
            {
                string msg = string.Empty;
                DictionaryDosage[] dosageArr = PharmacyDatabaseService.AllDictionaryDosages(out msg);
                if (string.IsNullOrEmpty(msg))
                {
                    this.dataGridView1.DataSource = dosageArr;
