    ...
    public partial class FormDrugInfoUnlock : BaseFunctionForm
    {
        ...
        private void search()
        {
            try
            {
                ...
                dgvMain.Columns["Price"].Visible = false;
                dgvMain.Columns["SalePrice"].Visible = false;
                dgvMain.Columns["WholeSalePrice"].Visible = false;
                dgvMain.Columns["RetailPrice"].Visible = false;
                dgvMain.Columns["LimitedUpPrice"].Visible = false;
