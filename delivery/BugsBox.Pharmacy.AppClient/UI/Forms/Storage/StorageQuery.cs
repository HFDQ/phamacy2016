    ...
    public partial class StorageQuery : BaseFunctionForm
    {
        ...
        private void Search()
        {
            try
            {
                ...
                storage = PharmacyDatabaseService.StorageQuery(out msg, this.textBox1.Text.Trim(), this.textBox2.Text.Trim(), this.textBox3.Text.Trim(), warehouseZonesIds, this.pagerControl1.PageIndex, this.pagerControl1.PageSize, new object[] { combine }).ToList();
