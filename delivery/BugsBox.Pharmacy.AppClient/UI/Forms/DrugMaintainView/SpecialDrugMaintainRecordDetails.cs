...
{
    public partial class SpecialDrugMaintainRecordDetails : BaseFunctionForm
    {
        public SpecialDrugMaintainRecordDetails()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            SpecialDrugMaintainRecordDetailEdit.IsEdit = true;
            SpecialDrugMaintainRecordDetailEdit item = new SpecialDrugMaintainRecordDetailEdit();
            item.ShowDialog();
            BindData();
        }
        ...
        {
            DrugMaintainRecordDetailId = Guid.Parse(dataGridView1.SelectedRows[0].Cells[0].Value.ToString());
            SpecialDrugMaintainRecordDetailEdit.IsEdit = false;
            SpecialDrugMaintainRecordDetailEdit item = new SpecialDrugMaintainRecordDetailEdit();
            item.ShowDialog();
        }
