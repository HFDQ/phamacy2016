...
{
    public partial class SpecialDrugMaintainRecord : BaseFunctionForm
    {
        public SpecialDrugMaintainRecord()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            {
                SpecialDrugMaintainRecordDetails detail = new SpecialDrugMaintainRecordDetails();
                SpecialDrugMaintainRecordDetails.BillDocumentNo = dataGridView1.SelectedRows[0].Cells[1].Value.ToString();
                detail.ShowDialog();
