...
{
    public partial class NormalDrugMaintainRecord : BaseFunctionForm
    {
        public NormalDrugMaintainRecord()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            {
                NormalDrugMaintainRecordDetails detail = new NormalDrugMaintainRecordDetails();
                NormalDrugMaintainRecordDetails.BillDocumentNo = dataGridView1.SelectedRows[0].Cells[1].Value.ToString();
                detail.ShowDialog();
