...
{
    public partial class DrugMaintainRecordPlanDetails : BaseFunctionForm
    {
        public DrugMaintainRecordPlanDetails()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            DrugMaintainRecordPlanDetailEdit.IsEdit = true;
            DrugMaintainRecordPlanDetailEdit item = new DrugMaintainRecordPlanDetailEdit();
            item.ShowDialog();
            BindData();
        }
        ...
        {
            DrugMaintainRecordDetailId = Guid.Parse(dataGridView1.SelectedRows[0].Cells[0].Value.ToString());
            DrugMaintainRecordPlanDetailEdit.IsEdit = false;
            DrugMaintainRecordPlanDetailEdit item = new DrugMaintainRecordPlanDetailEdit();
            item.ShowDialog();
        }
    }
