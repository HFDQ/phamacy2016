...
namespace BugsBox.Pharmacy.AppClient.UI.Report
{
    ...
    public class PrintHelper : IDisposable
    {
        ...
        {
            this.localReport.ReportEmbeddedResource = reportName;
        ...
        public PrintHelper(string reportName, List<object> reportData)
        {
            this.localReport.ReportEmbeddedResource = reportName;
            string warehouseManager = PharmacyClientConfig.Config.LastAccount;
            string storeName = PharmacyClientConfig.Config.Store.Name;
            ReportParameter rp = new ReportParameter("ReportTitle", storeName );
            ReportParameter warehouseman = new ReportParameter("warehouseManager", warehouseManager);
            this.localReport.SetParameters(rp);
            this.localReport.SetParameters(warehouseman);
            this.localReport.DataSources.Clear();
            int i = 0;
