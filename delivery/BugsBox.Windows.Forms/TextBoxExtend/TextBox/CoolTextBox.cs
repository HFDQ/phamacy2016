...
namespace BugsBox.Windows.Forms.Input
{
	...
	{
        private Color borderColor = System.Drawing.SystemColors.Window;
        ...
        public bool IsPwd
        {
            get
            {
                if (autoCompleteTextBox1 != null)
                {
                    return autoCompleteTextBox1.PasswordChar == '*';
                }
                return false;
            }
            set
            {
                if (autoCompleteTextBox1 != null&&value)
                {
                    autoCompleteTextBox1.PasswordChar = '*';
                }
            }
        }
		...
		{
            this.autoCompleteTextBox1 = new BugsBox.Windows.Forms.Input.AutoCompleteTextBox();
            this.SuspendLayout();
            // 
            // autoCompleteTextBox1
            // 
            this.autoCompleteTextBox1.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D;
            ...
            this.autoCompleteTextBox1.Size = new System.Drawing.Size(120, 22);
